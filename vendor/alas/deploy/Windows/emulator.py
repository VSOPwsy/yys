...
from vendor.alas.deploy.Windows.alas import AlasManager
from vendor.alas.deploy.Windows.logger import logger
from vendor.alas.deploy.Windows.utils import cached_property
...
class EmulatorManager(AlasManager):
    ...
    def emulator_manager(self):
        from vendor.alas.module.device.platform.emulator_windows import EmulatorManager
