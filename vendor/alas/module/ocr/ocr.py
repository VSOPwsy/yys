...
import vendor.alas.module.config.server as server
from vendor.alas.module.base.button import Button
...
from vendor.alas.module.ocr.rpc import ModelProxyFactory
from vendor.alas.module.webui.setting import State

if TYPE_CHECKING:
    from vendor.alas.module.ocr.al_ocr import AlOcr

if not State.deploy_config.UseOcrServer:
    from vendor.alas.module.ocr.models import OCR_MODEL
else:
