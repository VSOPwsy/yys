...
from vendor.alas.module.base.decorator import Config, cached_property, del_cached_property, run_once
from vendor.alas.module.base.timer import Timer
from vendor.alas.module.base.utils import ensure_time
from vendor.alas.module.config.deep import deep_get
from vendor.alas.module.config.server import VALID_CHANNEL_PACKAGE, VALID_PACKAGE, set_server
from vendor.alas.module.device.connection_attr import ConnectionAttr
from vendor.alas.module.device.env import IS_LINUX, IS_MACINTOSH, IS_WINDOWS
from vendor.alas.module.device.method.pool import WORKER_POOL
from vendor.alas.module.device.method.utils import (PackageNotInstalled, RETRY_TRIES, get_serial_pair, handle_adb_error,
                                        handle_unknown_host_service, possible_reasons, random_port, recv_all,
                                        remove_shell_warning, retry_sleep)
from vendor.alas.module.exception import EmulatorNotRunningError, RequestHumanTakeover
from vendor.alas.module.logger import logger
from vendor.alas.module.map.map_grids import SelectedGrids
...
class Connection(ConnectionAttr):
    ...
    def detect_device(self):
        ...
        def brute_force_connect():
            ...
            from vendor.alas.deploy.Windows.emulator import EmulatorManager
